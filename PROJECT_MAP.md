...
| `src/ui/projectScene` | Disconnected Scene/task navigation, save-state presentation, Caption list/pin filters/detail drafts, inclusion/pin modes, comparison-window state, viewing aids/entry-view and named-view/background controls (05 §13.3); synthetic ports only, no current-app hookup, floating renderer or rendered acceptance |
