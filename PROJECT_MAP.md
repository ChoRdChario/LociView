...
| `src/ui/projectScene` | Disconnected Scene/four-task navigation and save-state presentation (05 §13.3); synthetic ports only, no current-app hookup or rendered acceptance |
