...
export type PendingInteraction = 'text' | 'composition' | 'pinPlacement' | 'pinMove' | 'modelTransform' | 'camera' | 'window' | 'update';
...
const pendingReasons: Readonly<Record<PendingInteraction, string>> = Object.freeze({
  update: '更新を確認しています。未完了の更新がある場合は再試行してください。',
  window: 'ウィンドウの移動を終えてください。',
