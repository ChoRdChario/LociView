...
| `specs/04-locimyu-conversion.md` | `PRODUCT-OWNER APPROVED / BOUNDED DIRECT ADAPTER IMPLEMENTED / REPRESENTATIVE RETRY` | Exact LociMyu identity/source authority and report boundary; the first private representative correctly stopped before publication on six missing stable Caption IDs |
