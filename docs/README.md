...
| `specs/05-project-scene-team-workflow.md` | `PRODUCT-OWNER APPROVED / DISCONNECTED SCENE CORE AND RECORD GUARDS` | Scene command/composition and individual-record guards under §§13.1/13.3; no storage/UI integration or full Project validator. Team exchange/migration remains unimplemented; current Native bytes unchanged |
