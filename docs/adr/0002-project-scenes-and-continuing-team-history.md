...
production integration retains the applicable gates. Current bounded code and
evidence are recorded in `PROJECT_MAP.md` and `tasks/todo.md`, not implied here.
