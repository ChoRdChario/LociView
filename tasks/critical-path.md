...
| Complete domain provider and S1 durable host | Stage A now checks the amended whole-root/all 14 record maps and preserves unknown subtrees; full graph/candidate/content evidence and authoritative Project session remain absent | Complete B (closure/conflict/exact evidence) and C (same-host authority) under 05 §13.4; then gated durable repository/journal under §13.2. `valid-records` alone cannot supply trusted SceneResources |
