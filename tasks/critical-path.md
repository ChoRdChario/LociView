...
| Complete domain provider and S1 durable host | Stage A covers all 14 maps; B inspects graph/digests/prior identity and neutral original-change candidates/lifecycle causality. The served candidate exposes raw evidence; composed Project candidate/value/graph/content authority remains absent | Compose B's complete candidate and external-evidence checks, then C's same-host authority under 05 §13.4; gated durable repository/journal follows under §13.2. Intermediate inspections do not supply trusted SceneResources |
