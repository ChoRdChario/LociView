...
|---|---|---|
| Connected development workspace | Same-host synthetic team/Scene workflow under 05 §13.4. PO reports five prescribed camera/pin/window manual groups PASS at `7540478` on 2026-09-10; other team/rendered/device acceptance remains open | Scene-first Caption UX and discoverable later pin adjustment per UI guidelines §4.3/current todo. Distinguish layout requests from proposed surface-target rules. Reuse scoped PASS; no repeat journal/numeric-first test or parallel mock UI. Real-file/media and durable gates remain |
